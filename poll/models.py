...
class Question(models.Model):
    ...
    QUESTION_TYPES = (_('Multiplechoice'), QUESTION_TYPE_MULTIPLE), (_(
        'Singlechoice'), QUESTION_TYPE_SINGLE), (_('Textfield'),
        QUESTION_TYPE_TEXT), (_('Scala'), QUESTION_TYPE_SCALA)
    ...
    type = models.CharField(max_length=20, choices=QUESTION_TYPES, default=
        QUESTION_TYPE_TEXT, verbose_name=_('Type'))
    category = models.ForeignKey(verbose_name=_('Category'), to=Category,
        on_delete=models.CASCADE)
    number_range_end = models.IntegerField(help_text=number_rage_help,
        default=0)
